...
export default class questions extends Component {
    ...
    removeAllQuestions = () => {
        ...
        .then((response) => {
            ...
            if (!error) {
                ...
                this.setState({ 'profile_infos': profile_infos, 'involved': false })
            }
        })
    }
    ...
    render() {
        var { 
            ...
            prof_provide_answer_box, mate_provide_answer_box, involved, errormsg
        } = this.state
        ...
        return (
            <div className="main">
                ...
                { prof_provide_answer_box || mate_provide_answer_box || JSON.stringify(question_info) !== '{}' || involved ? 
                    <div className="hidden-box">
                        ...
                        : null }
                        { involved ? 
                            <div className="error-involved-box">
                                <div className="error-involved-header">You have asked one or more question(s)</div>
                                <div className="error-involved-header">Would you like to remove all your question(s)</div>

                                <div className="error-involved-options">
                                    <div className="error-involved-button" onClick={() => this.setState({ 'involved': false })}>No</div>
                                    <div className="error-involved-button" onClick={this.removeAllQuestions}>Yes</div>
                                </div>
                            </div>
                        : null }
                    </div>
